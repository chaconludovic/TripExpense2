...
import com.eldoraludo.tripexpense.SyntheseActivity;
...
public class ShakeListener implements SensorEventListener {
    ...
    private SyntheseActivity.ChargementDepensesEnArrierePlan chargementDepensesEnArrierePlan;

    public interface OnShakeListener {
        public void onShake();
    }

    public ShakeListener(Context context, SyntheseActivity.ChargementDepensesEnArrierePlan chargementDepensesEnArrierePlan) {

        Log.d(TAG, "ShakeListener invoked---->");
        mContext = context;
        this.chargementDepensesEnArrierePlan = chargementDepensesEnArrierePlan;
        resume();
    }
